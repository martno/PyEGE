/* Generated by Cython 0.11.2 on Mon Jan 04 21:31:13 2010 */
 ...
 *                 return
 */
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_v_II); if (unlikely(__pyx_t_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 568; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__pyx_t_1) {
 ...
 */
      ...
      __pyx_t_4 = __Pyx_PyInt_AsInt(__pyx_v_III); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 569; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_5 = __Pyx_PyInt_AsInt(__pyx_v_IV); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 569; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_6 = __Pyx_PyInt_AsInt(__pyx_v_V); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 569; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ((struct __pyx_obj_3ege_Image *)__pyx_v_self)->thisPtr = new Image(__pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6);
 ...
 *             color = III
 */
    __pyx_t_6 = __Pyx_PyInt_AsInt(__pyx_v_I); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
    __pyx_t_6 = __Pyx_PyInt_AsInt(__pyx_v_II); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 576; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *             arrayColor[0] = color[0]
 */
    __pyx_t_7 = PyObject_Length(__pyx_v_color); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 579; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_v_colorLength = __pyx_t_7;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_1);
    __pyx_t_8 = __Pyx_PyInt_AsUnsignedChar(__pyx_1); if (unlikely((__pyx_t_8 == (unsigned char)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 581; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
    (__pyx_v_arrayColor[0]) = __pyx_t_8;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_1);
    __pyx_t_8 = __Pyx_PyInt_AsUnsignedChar(__pyx_1); if (unlikely((__pyx_t_8 == (unsigned char)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 582; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
    (__pyx_v_arrayColor[1]) = __pyx_t_8;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_1);
    __pyx_t_8 = __Pyx_PyInt_AsUnsignedChar(__pyx_1); if (unlikely((__pyx_t_8 == (unsigned char)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 583; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
    (__pyx_v_arrayColor[2]) = __pyx_t_8;
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_1);
      __pyx_t_8 = __Pyx_PyInt_AsUnsignedChar(__pyx_1); if (unlikely((__pyx_t_8 == (unsigned char)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 587; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
      (__pyx_v_arrayColor[3]) = __pyx_t_8;
      break;
    }
...
static PyObject *__pyx_pf_3ege_5Image_draw(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_ssize_t __pyx_t_2;
  unsigned char __pyx_t_3;
  static PyObject **__pyx_pyargnames[] = {&__pyx_kp_x,&__pyx_kp_y,&__pyx_kp_bilinear,&__pyx_kp_scaleX,&__pyx_kp_scaleY,&__pyx_kp_rotate,&__pyx_kp_rotatePtX,&__pyx_kp_rotatePtY,&__pyx_kp_color,0};
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("draw", 0, 2, 9, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      if (kw_args > 1) {
    ...
    if (values[2]) {
      __pyx_v_bilinear = __Pyx_PyObject_IsTrue(values[2]); if (unlikely((__pyx_v_bilinear == (int)-1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_bilinear = 0;
    }
    if (values[3]) {
      __pyx_v_scaleX = __pyx_PyFloat_AsDouble(values[3]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_scaleX = 1.0;
    }
    if (values[4]) {
      __pyx_v_scaleY = __pyx_PyFloat_AsDouble(values[4]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_scaleY = 1.0;
    }
    if (values[5]) {
      __pyx_v_rotate = __pyx_PyFloat_AsDouble(values[5]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_rotate = 0.0;
    }
    if (values[6]) {
      __pyx_v_rotatePtX = __pyx_PyFloat_AsDouble(values[6]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_rotatePtX = 0.0;
    }
    if (values[7]) {
      __pyx_v_rotatePtY = __pyx_PyFloat_AsDouble(values[7]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      case  8:
      __pyx_v_rotatePtY = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 7)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  7:
      __pyx_v_rotatePtX = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 6)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  6:
      __pyx_v_rotate = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  5:
      __pyx_v_scaleY = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  4:
      __pyx_v_scaleX = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  3:
      __pyx_v_bilinear = __Pyx_PyObject_IsTrue(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_bilinear == (int)-1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  2:
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("draw", 0, 2, 9, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 598; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 *     def getWidth(self):
 */
  ((struct __pyx_obj_3ege_Image *)__pyx_v_self)->thisPtr->draw(__pyx_v_x, __pyx_v_y, __pyx_v_bilinear, __pyx_v_scaleX, __pyx_v_scaleY, __pyx_v_rotate, __pyx_v_rotatePtX, __pyx_v_rotatePtY, __pyx_v_arrayColor);
